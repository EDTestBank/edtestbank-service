...
//    public ListingService(REListingRepository reListingRepository) {
...
//                return reListingRepository.getREListingById(0L);
    }
...
//            logger.debug("eTag from Azure - [{}]", eTag);
    ...
    public static BBSOssezForumPost processInputFile(BBSOssezForumPost bbsossezForumPost, File inputFile) {
        ...
        try {
            ...
            HashMap<String, BigDecimal> matchingMap = ListingService.getMatchingMap(vendorList);
