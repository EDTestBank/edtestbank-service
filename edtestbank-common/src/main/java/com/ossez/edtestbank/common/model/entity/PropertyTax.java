...
@Entity
@Indexed
@Table(catalog = "reoctx", name = "property_tax")
public class PropertyTax extends DataObject implements Serializable {
    private static final long serialVersionUID = -5838121102958692727L;

    private static Logger logger = LoggerFactory.getLogger(PropertyTax.class);
